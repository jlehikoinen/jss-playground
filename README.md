...
> Note that if you have configured SMTP server and enabled email notifications in JSS you should consider this next option  carefully. Your organization's JSS admins might receive "The JSS webapp has been stopped/started." emails when you run JSS on your Mac..
